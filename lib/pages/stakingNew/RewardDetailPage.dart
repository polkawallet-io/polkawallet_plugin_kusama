...
class RewardDetailPage extends StatefulWidget {
  RewardDetailPage(this.plugin, {Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Container(
                padding:
                    EdgeInsets.only(left: 17, right: 20, top: 9, bottom: 10),
            ...
            Column(
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...widget.plugin.store.staking.txsRewards.map((i) {
                          ...
                          ListTile(
                            ...
                            leading: Container(
                              ...
                              child: TransferIcon(
                                ...
                                iconColor:
                                    isReward ? Colors.white : Color(0xFFFFA07E),
                              ),
                            ),
