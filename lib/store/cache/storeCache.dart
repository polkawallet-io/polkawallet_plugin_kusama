...
const String plugin_chainx_storage_key = 'plugin_chainx';
const String plugin_polkadot_storage_key = 'plugin_polkadot';

abstract class StoreCache {
  static final _storage = () => GetStorage(plugin_chainx_storage_key);
...
class StoreCacheChainX extends StoreCache {
  static final _storage = () => GetStorage(plugin_chainx_storage_key);
